...
| **CHECK_DAILY_COMBO**                 | Включить автоматическую покупку комбо карточек _(True / False)_                                           |
...
| **MAX_COMBO_PRICE**                   | Максимальная общая стоимость комбо карт, при которой будет срабатвать покупка комбо.                      |
